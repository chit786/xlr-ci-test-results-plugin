...
class SonarSummaryTileViewController {

    static $inject = ['sonarSummaryService', 'ReportLoader', 'Report'];

    constructor(sonarSummaryService, ReportLoader, Report) {
        this.sonarSummaryService = sonarSummaryService;
...
export const sonarSummaryTileView = {
    bindings: {
        tile: '<'
    },
    controller: SonarSummaryTileViewController,
    template
};
