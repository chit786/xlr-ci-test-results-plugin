...
class SonarSummaryTileConfigController {

    static $inject = ['sonarSummaryService', 'Ids', '$q', '$timeout'];

    constructor(sonarSummaryService, Ids, $q, $timeout) {
...
export const sonarSummaryTileConfig = {
    bindings: {
        tile: '<',
        parent: '<'
    },
    controller: SonarSummaryTileConfigController,
    template
};
